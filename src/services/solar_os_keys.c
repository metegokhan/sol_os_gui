...
static const key_name_t key_names[] = {
    ...
    {"VOLUME_UP", SOLAR_OS_KEY_AUDIO_VOLUME_UP},
    {"VOLUME_DOWN", SOLAR_OS_KEY_AUDIO_VOLUME_DOWN},
    {"VOL_UP", SOLAR_OS_KEY_AUDIO_VOLUME_UP},
    {"VOL_DOWN", SOLAR_OS_KEY_AUDIO_VOLUME_DOWN},
