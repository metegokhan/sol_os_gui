...
#define SOLAR_OS_GAMEBOY_SCALE 2U
#define SOLAR_OS_GAMEBOY_BITMAP_WIDTH                                          \
  (SOLAR_OS_GAMEBOY_LCD_WIDTH * SOLAR_OS_GAMEBOY_SCALE)
#define SOLAR_OS_GAMEBOY_BITMAP_HEIGHT                                         \
  (SOLAR_OS_GAMEBOY_LCD_HEIGHT * SOLAR_OS_GAMEBOY_SCALE)
#define SOLAR_OS_GAMEBOY_BITMAP_STRIDE (SOLAR_OS_GAMEBOY_BITMAP_WIDTH / 8U)
