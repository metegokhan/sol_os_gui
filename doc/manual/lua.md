...
On ESP32-S3 targets with `service.hid`, the same USB connection remains
available as `cdc0` while also advertising keyboard, mouse, and gamepad HID
reports. Lua uses the same typed operations and constants as Python:
