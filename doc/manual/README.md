...
- [Playground](playground.md) — Browse, download, remove, and run community Python and Lua applications
- [playground application](apps.md#playground) — Browse the configured community catalog as a foldable category tree, search applications, and download, update, remove, or run Python and Lua scripts.
