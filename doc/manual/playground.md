...
the URL of its generated `dist/catalog.json`:
...
The chosen source is stored in NVS. Each archive is checked against the exact
size and SHA-256 digest declared by the downloaded catalog before installation.
